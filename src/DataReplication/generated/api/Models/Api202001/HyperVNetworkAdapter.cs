...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class HyperVNetworkAdapter :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapter,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.IPAddressList { get => this._iPAddressList; set { {_iPAddressList = value;} } }

        /// <summary>Internal Acessors for IPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.IPAddressType { get => this._iPAddressType; set { {_iPAddressType = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.NetworkId { get => this._networkId; set { {_networkId = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.NicId { get => this._nicId; set { {_nicId = value;} } }

        /// <summary>Internal Acessors for NicType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.NicType { get => this._nicType; set { {_nicType = value;} } }

        /// <summary>Internal Acessors for StaticIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.StaticIPAddress { get => this._staticIPAddress; set { {_staticIPAddress = value;} } }

        /// <summary>Internal Acessors for SubnetName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVNetworkAdapterInternal.SubnetName { get => this._subnetName; set { {_subnetName = value;} } }
