...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class OperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
