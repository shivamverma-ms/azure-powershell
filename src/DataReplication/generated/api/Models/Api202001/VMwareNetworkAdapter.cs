...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class VMwareNetworkAdapter :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapter,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal
    {
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.IPAddressList { get => this._iPAddressList; set { {_iPAddressList = value;} } }

        /// <summary>Internal Acessors for IPAddressType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.IPAddressType { get => this._iPAddressType; set { {_iPAddressType = value;} } }

        /// <summary>Internal Acessors for Label</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for MacAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.MacAddress { get => this._macAddress; set { {_macAddress = value;} } }

        /// <summary>Internal Acessors for NetworkName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.NetworkName { get => this._networkName; set { {_networkName = value;} } }

        /// <summary>Internal Acessors for NicId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareNetworkAdapterInternal.NicId { get => this._nicId; set { {_nicId = value;} } }
