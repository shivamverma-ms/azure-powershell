...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class SiteHealthSummary :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummary,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.AffectedResourceType { get => this._affectedResourceType; set { {_affectedResourceType = value;} } }

        /// <summary>Internal Acessors for ApplianceName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.ApplianceName { get => this._applianceName; set { {_applianceName = value;} } }

        /// <summary>Internal Acessors for ErrorCode</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.ErrorCode { get => this._errorCode; set { {_errorCode = value;} } }

        /// <summary>Internal Acessors for ErrorId</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.ErrorId { get => this._errorId; set { {_errorId = value;} } }

        /// <summary>Internal Acessors for ErrorMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.ErrorMessage { get => this._errorMessage; set { {_errorMessage = value;} } }

        /// <summary>Internal Acessors for RemediationGuidance</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.RemediationGuidance { get => this._remediationGuidance; set { {_remediationGuidance = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.Severity { get => this._severity; set { {_severity = value;} } }

        /// <summary>Internal Acessors for SummaryMessage</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteHealthSummaryInternal.SummaryMessage { get => this._summaryMessage; set { {_summaryMessage = value;} } }
