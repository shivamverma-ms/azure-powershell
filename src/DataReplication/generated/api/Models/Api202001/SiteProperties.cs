...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class SiteProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISitePropertiesInternal
    {

        /// <summary>Backing field for <see cref="AgentDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentProperties _agentDetail;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentProperties AgentDetail { get => (this._agentDetail = this._agentDetail ?? new Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.SiteAgentProperties()); set => this._agentDetail = value; }
        ...
        public string AgentDetailId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).Id; }

        /// <summary>Key vault ARM Id.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataReplication.PropertyOrigin.Inlined)]
        public string AgentDetailKeyVaultId { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).KeyVaultId; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).KeyVaultId = value ?? null; }

        /// <summary>Key vault URI.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataReplication.PropertyOrigin.Inlined)]
        public string AgentDetailKeyVaultUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).KeyVaultUri; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).KeyVaultUri = value ?? null; }

        /// <summary>Last heartbeat time of the agent in UTC.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataReplication.PropertyOrigin.Inlined)]
        public global::System.DateTime? AgentDetailLastHeartBeatUtc { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).LastHeartBeatUtc; }

        /// <summary>Version of the agent.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataReplication.PropertyOrigin.Inlined)]
        public string AgentDetailVersion { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteAgentPropertiesInternal)AgentDetail).Version; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISitePropertiesInternal.ServiceEndpoint { get => this._serviceEndpoint; set { {_serviceEndpoint = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISiteSpnProperties _servicePrincipalIdentityDetail;
