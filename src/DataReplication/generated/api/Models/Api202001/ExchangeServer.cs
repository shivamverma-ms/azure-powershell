...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class ExchangeServer :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServer,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal.Edition { get => this._edition; set { {_edition = value;} } }

        /// <summary>Internal Acessors for ProductName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal.ProductName { get => this._productName; set { {_productName = value;} } }

        /// <summary>Internal Acessors for Role</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal.Role { get => this._role; set { {_role = value;} } }

        /// <summary>Internal Acessors for ServicePack</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal.ServicePack { get => this._servicePack; set { {_servicePack = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IExchangeServerInternal.Version { get => this._version; set { {_version = value;} } }
