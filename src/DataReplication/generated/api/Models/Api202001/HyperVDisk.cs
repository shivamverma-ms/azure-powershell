...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class HyperVDisk :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDisk,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.DiskType { get => this._diskType; set { {_diskType = value;} } }

        /// <summary>Internal Acessors for InstanceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.InstanceId { get => this._instanceId; set { {_instanceId = value;} } }

        /// <summary>Internal Acessors for Lun</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.Lun { get => this._lun; set { {_lun = value;} } }

        /// <summary>Internal Acessors for MaxSizeInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.MaxSizeInByte { get => this._maxSizeInByte; set { {_maxSizeInByte = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Path</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.Path { get => this._path; set { {_path = value;} } }

        /// <summary>Internal Acessors for VhdId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IHyperVDiskInternal.VhdId { get => this._vhdId; set { {_vhdId = value;} } }
