...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class SystemCenter :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISystemCenter,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISystemCenterInternal
    {

        /// <summary>Internal Acessors for ProductName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISystemCenterInternal.ProductName { get => this._productName; set { {_productName = value;} } }

        /// <summary>Internal Acessors for Status</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISystemCenterInternal.Status { get => this._status; set { {_status = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.ISystemCenterInternal.Version { get => this._version; set { {_version = value;} } }
