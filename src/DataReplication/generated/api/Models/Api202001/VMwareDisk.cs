...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class VMwareDisk :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDisk,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal
    {

        /// <summary>Backing field for <see cref="DiskMode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode? _diskMode;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode? DiskMode { get => this._diskMode; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.DiskMode { get => this._diskMode; set { {_diskMode = value;} } }

        /// <summary>Internal Acessors for DiskProvisioningPolicy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.DiskProvisioningPolicy { get => this._diskProvisioningPolicy; set { {_diskProvisioningPolicy = value;} } }

        /// <summary>Internal Acessors for DiskScrubbingPolicy</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.DiskScrubbingPolicy { get => this._diskScrubbingPolicy; set { {_diskScrubbingPolicy = value;} } }

        /// <summary>Internal Acessors for DiskType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.DiskType { get => this._diskType; set { {_diskType = value;} } }

        /// <summary>Internal Acessors for Label</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.Label { get => this._label; set { {_label = value;} } }

        /// <summary>Internal Acessors for Lun</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.Lun { get => this._lun; set { {_lun = value;} } }

        /// <summary>Internal Acessors for MaxSizeInByte</summary>
        long? Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.MaxSizeInByte { get => this._maxSizeInByte; set { {_maxSizeInByte = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Path</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.Path { get => this._path; set { {_path = value;} } }

        /// <summary>Internal Acessors for Uuid</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IVMwareDiskInternal.Uuid { get => this._uuid; set { {_uuid = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode) })]
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode? DiskMode { get;  }
        /// <summary>
        /// The provisioning policy of the disk. It is Thin or Thick or Unknown for the VMWare.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Runtime.Info(
    ...
    {
        /// <summary>Disk mode property used for identifying independent disks.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support.VirtualDiskMode? DiskMode { get; set; }
        /// <summary>
        /// The provisioning policy of the disk. It is Thin or Thick or Unknown for the VMWare.
        /// </summary>
