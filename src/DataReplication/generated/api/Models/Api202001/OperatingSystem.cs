...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001
{
    ...
    public partial class OperatingSystem :
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperatingSystem,
        Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperatingSystemInternal
    {

        /// <summary>Internal Acessors for OSName</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperatingSystemInternal.OSName { get => this._oSName; set { {_oSName = value;} } }

        /// <summary>Internal Acessors for OSType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperatingSystemInternal.OSType { get => this._oSType; set { {_oSType = value;} } }

        /// <summary>Internal Acessors for OSVersion</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api202001.IOperatingSystemInternal.OSVersion { get => this._oSVersion; set { {_oSVersion = value;} } }
