...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Support";
    private const string PropertiesExcludedForTableview = @"Type";
