...
function New-AzDataReplicationVMwareToAvsFailbackProtectedItemModelCustomPropertiesObject {
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api20210216Preview.VMwareToAvsFailbackProtectedItemModelCustomProperties]::New()

        if ($PSBoundParameters.ContainsKey('ProtectedDisk')) {
            $Object.ProtectedDisk = $ProtectedDisk
        }
