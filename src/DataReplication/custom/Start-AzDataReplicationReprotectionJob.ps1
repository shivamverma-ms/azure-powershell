...
function Start-AzDataReplicationReprotectionJob {
    ...
    param (
        ...
        # Specifies custom property for reprotection
        ${CustomProperty},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Category('Body')]
        [System.String]
        # Specifies id of log storage account
        ${LogStorageAccountId},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Category('Body')]
        [System.String]
        # Specifies id of replication appliance
        ${ApplianceId},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Category('Body')]
        [System.String]
        # Specifies name of replication extension
    ...
    process {
        ...
        if ($parameterSet -eq "ByProtectedItemIdExpanded" -or $parameterSet -eq "ByInputObjectExpanded") {
            ...
            $CustomProperty.DatastoreName = $DatastoreName
            $CustomProperty.LogStorageAccountId = $LogStorageAccountId
            $CustomProperty.ApplianceId = $ApplianceId
            $CustomProperty.ReplicationExtensionName = $ReplicationExtensionName
