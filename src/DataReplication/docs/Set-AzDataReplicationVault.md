...
online version: https://docs.microsoft.com/powershell/module/az.datareplication/set-azdatareplicationvault
schema: 2.0.0
---

# Set-AzDataReplicationVault
...
```
Set-AzDataReplicationVault -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Update
```
Set-AzDataReplicationVault -Name <String> -ResourceGroupName <String> -Body <IVaultModel>
