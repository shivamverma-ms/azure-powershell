...
online version: https://docs.microsoft.com/powershell/module/az.datareplication/new-azdatareplicationextension
schema: 2.0.0
---

# New-AzDataReplicationExtension
...
```
New-AzDataReplicationExtension -Name <String> -ResourceGroupName <String> -VaultName <String>
