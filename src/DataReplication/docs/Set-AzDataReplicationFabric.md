...
online version: https://docs.microsoft.com/powershell/module/az.datareplication/set-azdatareplicationfabric
schema: 2.0.0
---

# Set-AzDataReplicationFabric
...
```
Set-AzDataReplicationFabric -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-CustomPropertyInstanceType <String>] [-Location <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Set-AzDataReplicationFabric -Name <String> -ResourceGroupName <String> -Body <IFabricModel>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataReplication.Models.Api20210216Preview.IFabricModel
