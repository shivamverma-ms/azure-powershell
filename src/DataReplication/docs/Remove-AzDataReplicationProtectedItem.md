...
online version: https://docs.microsoft.com/powershell/module/az.datareplication/remove-azdatareplicationprotecteditem
schema: 2.0.0
---
...
```
Remove-AzDataReplicationProtectedItem -Name <String> -ResourceGroupName <String> -VaultName <String>
