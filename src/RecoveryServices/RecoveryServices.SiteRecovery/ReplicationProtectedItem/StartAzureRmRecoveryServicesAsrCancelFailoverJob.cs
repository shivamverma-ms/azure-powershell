...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    public class StartAzureRmRecoveryServicesAsrCancelFailoverJob : SiteRecoveryCmdletBase
    {
        ...
        /// </summary>
        private void SetRPICancelFailover()
        {
            if (string.Compare(
                ...
                0)
            {
                ...
                var parseFlag = Guid.TryParse(
                    ((ASRInMageRcmFailbackSpecificRPIDetails)this
                        .ReplicationProtectedItem
                        .ProviderSpecificDetails).MultiVmGroupName,
                    out guidResult);
                if (parseFlag == false || guidResult == Guid.Empty)
                {
                    throw new InvalidOperationException(
                        string.Format(
                            Resources
                                .UnsupportedReplicationProtectionActionForCancelFailover,
