...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    /// </summary>
    public class ASRInMageRcmFabricSpecificDetail : ASRFabricSpecificDetails
    {
        /// <summary>
    ...
    public class ASRProcessServerDetails
    {
        ...
        /// <summary>
        ///     Gets the processor usage status.
        ///     Possible values include: 'Normal', 'Warning', 'Error', 'Unknown'
        /// </summary>
        public string ProcessorUsageStatus { get; }

        /// <summary>
        ///     Gets the memory usage status.
        ///     Possible values include: 'Normal', 'Warning', 'Error', 'Unknown'
        /// </summary>
        public string MemoryUsageStatus { get; }

        /// <summary>
        ///     Gets the disk usage status.
        ///     Possible values include: 'Normal', 'Warning', 'Error', 'Unknown'
        /// </summary>
        public string DiskUsageStatus { get; }

        /// <summary>
        ///     Gets the system load status.
        ///     Possible values include: 'Normal', 'Warning', 'Error', 'Unknown'
        /// </summary>
    ...
    public class ASRAgentDetails
    {
        ...
        public ASRAgentDetails(AgentDetails agentDetails)
        {
            ...
            {
                this.Disks = agentDetails.Disks.ToList()
    ...
    public class ASRInMageRcmSpecificRPIDetails : ASRProviderSpecificRPIDetails
    {
        ...
        public ASRInMageRcmSpecificRPIDetails(InMageRcmReplicationDetails details)
        {
            ...
            this.MobilityAgentDetails = new ASRInMageRcmMobilityAgentDetails(details.MobilityAgentDetails);
