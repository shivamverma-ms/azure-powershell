...
namespace Microsoft.Azure.Commands.RecoveryServices.SiteRecovery
{
    ...
    public class ASRFabric
    {
            ...
            Fabric fabric)
        {
            ...
            else if (fabric.Properties.CustomDetails is InMageRcmFabricSpecificDetails)
            {
                ...
                var fabricSpecificDetails = new ASRInMageRcmFabricSpecificDetail
                {
            ...
            else if (policy.Properties.ProviderSpecificDetails is InMageRcmPolicyDetails)
            {
                ...
                var replicationProviderSettings =
                    new ASRInMageRcmPolicyDetails
                    {
                        AppConsistentFrequencyInMinutes =
                            (int)details.AppConsistentFrequencyInMinutes,
                        RecoveryPointHistory = (int)details.RecoveryPointHistoryInMinutes,
                        CrashConsistentFrequencyInMinutes =
                            (int)details.CrashConsistentFrequencyInMinutes,
    ...
    public class ASRInMageRcmProtectedDiskDetails
    {
        ...
        /// class.
        /// </summary>
        public ASRInMageRcmProtectedDiskDetails()
        {
        }
        ...
        public ASRInMageRcmProtectedDiskDetails(InMageRcmProtectedDiskDetails disk)
        {
            ...
            this.IrDetails = disk.IrDetails;
            this.ResyncDetails = disk.ResyncDetails;
        }
        ...
        /// <summary>
        ///     Gets the disk type. Possible values include: 'Standard_LRS', 'Premium_LRS', 'StandardSSD_LRS'
        /// </summary>
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ASRInMageRcmFailbackProtectedDiskDetails" />
        ///     class.
        /// </summary>
        public ASRInMageRcmFailbackProtectedDiskDetails()
        {
        }
    ...
    public class ASRInMageRcmFailbackNicDetails
    {
        ...
        ///     class.
        /// </summary>
        public ASRInMageRcmFailbackNicDetails()
        {
        }
    ...
    public class ASRInMageRcmMobilityAgentDetails
    {
        ...
        ///     class.
        /// </summary>
        public ASRInMageRcmMobilityAgentDetails()
        {
        }
    ...
    public class ASRInMageRcmFailbackMobilityAgentDetails
    {
        ...
        ///     class.
        /// </summary>
        public ASRInMageRcmFailbackMobilityAgentDetails()
        {
        }
    ...
    public class ASRInMageRcmLastAgentUpgradeErrorDetails
    {
        ...
        ///     class.
        /// </summary>
        public ASRInMageRcmLastAgentUpgradeErrorDetails()
        {
        }
    ...
    public class ASRInMageRcmAgentUpgradeBlockingErrorDetails
    {
        ...
        ///     class.
        /// </summary>
        public ASRInMageRcmAgentUpgradeBlockingErrorDetails()
        {
        }
