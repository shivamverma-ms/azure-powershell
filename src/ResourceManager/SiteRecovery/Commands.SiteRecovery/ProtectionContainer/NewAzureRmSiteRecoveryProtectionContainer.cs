...
{
    /// <summary>
    /// Adds a new Azure Site Recovery Protection Container.
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AzureRmSiteRecoveryProtectionContainer")]
    [OutputType(typeof(ASRJob))]
    public class NewAzureRmSiteRecoveryProtectionContainer : SiteRecoveryCmdletBase
    {
        #region Parameters
        ...
        /// <summary>
        /// Gets or sets the fabric under which the container is to be created.
        /// </summary>
