...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureRmSiteRecoveryStorageClassificationNM", DefaultParameterSetName = ASRParameterSets.Default)]
    [OutputType(typeof(IEnumerable<ASRStorageClassification>))]
    public class GetAzureRmSiteRecoveryStorageClassificationNM : SiteRecoveryCmdletBase
    {
        #region Parameters
        /// <summary>
