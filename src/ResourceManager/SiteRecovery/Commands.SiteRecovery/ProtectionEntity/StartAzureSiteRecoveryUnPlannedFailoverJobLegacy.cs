...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Start, "AzureRmSiteRecoveryUnplannedFailoverJobLegacy", DefaultParameterSetName = ASRParameterSets.ByPEObject)]
    [OutputType(typeof(ASRJob))]
    public class StartAzureSiteRecoveryUnplannedFailoverJobLegacy : SiteRecoveryCmdletBase
    {
