...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Start, "AzureRmSiteRecoveryPlannedFailoverJobLegacy", DefaultParameterSetName = ASRParameterSets.ByPEObject)]
    [OutputType(typeof(ASRJob))]
    public class StartAzureSiteRecoveryPlannedFailoverJobLegacy : SiteRecoveryCmdletBase
    {
        ...
        public override void ExecuteSiteRecoveryCmdlet()
        {
            ...
            this.WriteWarningWithTimestamp(
                string.Format(Properties.Resources.CmdletWillBeDeprecatedSoon,
                    ...
                    "Start-AzureRmSiteRecoveryPlannedFailover"));
