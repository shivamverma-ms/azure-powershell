...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsData.Edit, "AzureRmSiteRecoveryRecoveryPlanLegacy", DefaultParameterSetName = ASRParameterSets.AppendGroup)]
    public class EditAzureRmSiteRecoveryRecoveryPlanLegacy : SiteRecoveryCmdletBase
    {
        #region Parameters
