...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AzureRmSiteRecoveryRecoveryPlanLegacy", DefaultParameterSetName = ASRParameterSets.EnterpriseToEnterprise)]
    public class NewAzureRmSiteRecoveryRecoveryPlanLegacy : SiteRecoveryCmdletBase
    {
        /// <summary>
