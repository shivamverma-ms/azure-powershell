...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureRmSiteRecoveryNetworkNM", DefaultParameterSetName = ASRParameterSets.Default)]
    [OutputType(typeof(IEnumerable<ASRNetwork>))]
    public class GetAzureRmSiteRecoveryNetworkNM : SiteRecoveryCmdletBase
    {
        #region Parameters
        /// <summary>
