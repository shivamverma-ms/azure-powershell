...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsLifecycle.Start, "AzureRmSiteRecoveryTestFailoverCleanupJob", DefaultParameterSetName = ASRParameterSets.ByPEObject)]
    [OutputType(typeof(ASRJob))]
    public class StartAzureRmSiteRecoveryTestFailoverCleanupJob : SiteRecoveryCmdletBase
    {
