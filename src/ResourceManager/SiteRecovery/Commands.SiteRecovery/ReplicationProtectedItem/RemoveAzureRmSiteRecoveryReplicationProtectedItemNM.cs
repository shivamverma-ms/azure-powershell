...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureRmSiteRecoveryReplicationProtectedItemNM", DefaultParameterSetName = ASRParameterSets.DisableDR, SupportsShouldProcess = true)]
    ...
    public class RemoveAzureRmSiteRecoveryReplicationProtectedItemNM : SiteRecoveryCmdletBase
    {
        ...
        public override void ExecuteSiteRecoveryCmdlet()
        {
            ...
            this.ConfirmAction(
                ...
                string.Format(Properties.Resources.DisableProtectionWhatIfMessage, Constants.DisableProtection),
                this.targetNameOrId,
                () =>
                {
                    if (!Force.IsPresent)
