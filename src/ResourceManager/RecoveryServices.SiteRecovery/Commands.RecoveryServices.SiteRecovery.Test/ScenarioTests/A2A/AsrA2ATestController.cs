...
{
    public sealed class AsrA2ATestController : RMTestBase
    {
        ...
        public static AsrA2ATestController NewInstance
        {
            get
            {
                return new AsrA2ATestController();
            }
        }

        public AsrA2ATestController()
        {
            helper = new EnvironmentSetupHelper();
        }

        public void RunPsTest(Microsoft.Azure.ServiceManagemenet.Common.Models.XunitTracingInterceptor logger, params string[] scripts)
        {
