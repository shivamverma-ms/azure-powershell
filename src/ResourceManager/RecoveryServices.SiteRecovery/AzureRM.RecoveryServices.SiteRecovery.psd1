...
AliasesToExport = 'Edit-ASRRP', 'Edit-ASRRecoveryPlan', 'Get-ASRAlertSetting', 
               ...
               'Get-AzureRmRecoveryServicesAsrVaultSettings', 'New-ASRAzureToAzureDiskReplicationConfig',
               'New-ASRFabric', 'New-ASRNetworkMapping', 'New-ASRPolicy', 'New-ASRProtectableItem', 
               'New-ASRProtectionContainer', 'New-ASRProtectionContainerMapping', 'New-ASRRP', 
               ...
               'Remove-ASRProtectionContainer', 'Remove-ASRProtectionContainerMapping', 'Remove-ASRRP', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Changes for ASR Azure to Azure Site Recovery (cmdlets are currently supporting operations for Enterprise to Enterprise, Enterprise to Azure, HyperV to Azure,VMware to Azure)
    - New-AzureRmRecoveryServicesAsrProtectionContainer
    - New-AzureRmRecoveryServicesAsrAzureToAzureDiskReplicationConfig
    - Remove-AzureRmRecoveryServicesAsrProtectionContainer
    - Update-AzureRmRecoveryServicesAsrProtectionDirection
